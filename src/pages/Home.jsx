...
export default function Home({ onAddToCart, isLoggedIn}) {
  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-white overflow-hidden relative">
      ...
      {/* NEWSLETTER / JOIN COMMUNITY BANNER - Only renders if user is NOT logged in */}
      {!isLoggedIn && (
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pb-20 sm:pb-28 z-10 relative">
          <div className="rounded-3xl sm:rounded-[40px] overflow-hidden bg-gradient-to-r from-violet-700 to-fuchsia-600 p-6 sm:p-12 text-center shadow-2xl shadow-violet-600/20">
            ...
            <div className="mt-8 flex justify-center">
              <Link
                to="/register"
                className="rounded-xl sm:rounded-2xl bg-black hover:bg-zinc-900 active:scale-95 text-white px-8 py-3.5 sm:py-4 font-semibold text-sm sm:text-base transition-all duration-200 shadow-lg inline-block"
              >
