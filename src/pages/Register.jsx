        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/30 bg-violet-500/10 px-3.5 py-1.5 text-xs text-violet-300 mb-4 backdrop-blur-md">
              <Sparkles size={14} /> Join VELORA
            </div>
            <h2 className="text-3xl font-black tracking-tight">Create Account</h2>
            <p className="text-zinc-400 text-sm mt-2">
              Get started with your exclusive shopping experience.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-2xl bg-zinc-800/80 border border-white/10 pl-11 pr-4 py-3 text-sm text-white placeholder:text-zinc-500 outline-none focus:border-violet-500 transition"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full rounded-2xl bg-zinc-800/80 border border-white/10 pl-11 pr-11 py-3 text-sm text-white placeholder:text-zinc-500 outline-none focus:border-violet-500 transition"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 py-3.5 font-semibold text-white shadow-lg shadow-violet-500/20 hover:scale-[1.01] active:scale-95 transition flex items-center justify-center gap-2 disabled:opacity-50 mt-4"
            >
              {loading ? (
                <>
